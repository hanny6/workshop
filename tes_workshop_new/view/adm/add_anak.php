<h3 class="page-header">Tambah Data Anak Baru</h3>
<?php 
	if (isset($_GET['st'])) {
		if ($_GET['st']==1) {
      ...
      echo "<div class='alert alert-danger'><strong>Kode sudah terdaftar!</strong></div>";
    }
	}
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" name="kode" placeholder="Masukan Kode" required>
    </div>
  </div>
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" name="add_anak">Simpan</button>
      <button type="reset" class="btn btn-warning" name="add_anak">Reset</button>
    </div>
  </div>
</form>
